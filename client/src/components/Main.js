  ...
  return (
    <div className="main-container">
      ...
      <div className="main-album">
        ...
        setLargePhoto={setLargePhoto} setLargePhotoActive={setLargePhotoActive}/>
     </div>
     {showUpload && <Uploader setShowUpload = {setShowUpload} photos={photos} setPhotos={setPhotos} />}
     {largePhotoActive && <EnlargedPhoto setLargePhotoActive = {setLargePhotoActive} largePhoto={largePhoto} />}
     <div onClick={setShowUpload} className="add-photo" >+</div>
    </div>
  );
}
